...
class Library:
    ...
    def register_member(self, member_name, member_id):
        """
        The function `register_member` creates a new Member object with a given name and ID, adds it to
        a dictionary of members using the ID as the key, and prints a registration message.
        
        :param member_name: The `member_name` parameter is a string that represents the name of the
        member being registered
        :param member_id: The `member_id` parameter is the unique identifier for a member being
        registered in the system. It is used to uniquely identify each member and is typically a string
        or integer value
        """
    ...
    def borrow_book(self, member_id, book_id):
        if member_id in self.members and book_id in self.books:
            ...
            if book.is_available:
                ...
                print(f"Sorry, the book '{book.book_title}' is not available.")
        else:

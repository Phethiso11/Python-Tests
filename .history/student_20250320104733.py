...
<<<<<<< Tabnine <<<<<<<
        def display_details(self):
            """#+
            Display the student's details including name, ID, and enrolled courses.#+
#+
            Parameters:#+
            self (Student): The instance of the Student class.#+
#+
            Returns:#+
            None. The function prints the student's details to the console.#+
            """#+
...
>>>>>>> Tabnine >>>>>>># {"conversationId":"17a33cc7-7df6-4f4f-b703-a7fc982254b0","source":"instruct"}

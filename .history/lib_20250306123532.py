class Book:
    """
    The code defines classes for a library management system where users can add books, register
    members, borrow and return books, and display information about books and members.
    """

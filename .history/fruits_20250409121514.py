        ...
        if choice == "1":
            ...
            if fruit_name in fruits:
                ...
                try:
                   ...
                   # `fruits[fruit_name] = price` is adding a new key-value pair to the `fruits`
                   # dictionary. The key is `fruit_name`, which is the name of the fruit entered by
                   # the user, and the value is `price`, which is the price per kg of that fruit
                   # entered by the user. This line effectively adds a new fruit to the dictionary
